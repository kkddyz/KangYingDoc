...
![image-20211017163155202](https://kkddyz-oss-image-hosting-service.oss-cn-hangzhou.aliyuncs.com/image/20211017163155.png)

> 应用程序通过API把控制权交给操作系统。



![image-20211017163458474](https://kkddyz-oss-image-hosting-service.oss-cn-hangzhou.aliyuncs.com/image/20211017163458.png)

> WINSOCK是对socket的扩展，之后的例子会使用WINSOCK编程。	
...
IP编址的对象实际上是与物理链路，实现了网络层功能的<font color="red">接口</font>。
...
<font color="red">数据链路层</font>负责通过一条链路从一个<font color="blue">节点</font>向另一个物理链路<font color="red">直接相连</font>的<font color="blue">相邻节点</font>传送数据报.
